...
contract SendPackedUserOp is Script {
    ...
    function run() public {
        ...
        address dest = helperConfig.getConfig().usdc; // arbitrum mainnet usdc
        uint256 value = 0;
        ...
        PackedUserOperation memory userOp =
            generatedSignedUserOperation(executeCalldata, helperConfig.getConfig(), minimalAccountAddress);
